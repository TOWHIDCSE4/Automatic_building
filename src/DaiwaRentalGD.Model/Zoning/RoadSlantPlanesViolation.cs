...
{
    /// <summary>
    /// Describes a violation of road slant planes.
    /// </summary>
    [Serializable]
    public class RoadSlantPlanesViolation : IWorkspaceItem
    {
        #region Constructors

        public RoadSlantPlanesViolation()
        {
            ItemInfo = new WorkspaceItemInfo();
        }

        protected RoadSlantPlanesViolation(
