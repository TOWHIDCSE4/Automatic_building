...
namespace DaiwaRentalGD.Gui.Visualization3D
{
    ...
    /// </summary>
    public class WalkwayEntranceModel3DBuilder
    {
        #region Constructors

        public WalkwayEntranceModel3DBuilder()
        { }
        ...
        public Model3D CreateModel(WalkwayEntrance walkwayEntrance)
        {
            var walkwayEntranceModel = new Model3DGroup
            {
                Transform = Viewport3DUtils.ConvertToTransform3D(
                    walkwayEntrance.WalkwayEntranceComponent.Transform
                )
            };

            var markModel = CreateMarkModel();

            walkwayEntranceModel.Children.Add(markModel);

            return walkwayEntranceModel;
        }
